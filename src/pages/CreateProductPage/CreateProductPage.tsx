...
function CreateProductPage() {
	...
	const { register, handleSubmit, watch, formState: { errors, isValid }, reset } = useForm<ProductFormValues>({mode: "onChange"});
    ...
    <div className={styles.page}>
      <h1 className={styles.title}>Add Product</h1>
        ...
        <div className={styles.field}>
          ...
          <div className={styles.error}>{errors?.description && <div>{errors?.description?.message}</div>}</div>
        </div>
